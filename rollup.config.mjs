...
const sdPlugin = "com.orionwong.cursor-usage-ring.sdPlugin";

/** @type {import('rollup').RollupOptions} */
const config = {
	input: "src/plugin.ts",
	external: (id) => id === "@resvg/resvg-js" || id.startsWith("@resvg/resvg-js-"),
	output: {
